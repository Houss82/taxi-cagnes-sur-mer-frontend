  ...
  const breadcrumbItems = [
    {
      name: "Blog",
      url: "/blog",
      title: "Blog Taxi Cagnes-sur-Mer",
    },
  ];
        ...
        <div className="container mx-auto px-4 h-full flex items-center relative z-10">
          <div className="text-white max-w-3xl space-y-4">
            <h1 className="text-5xl md:text-6xl font-bold">
              Blog & Actualités Taxi Cagnes-sur-Mer
            </h1>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="p-6 space-y-4">
                      ...
                      <Link href={`/blog/${post.slug}`} prefetch>
                        <h2 className="text-2xl font-bold text-gray-900 leading-tight hover:text-accent transition-colors">
                          {post.title}
                        </h2>
                      </Link>
