...
export const metadata = {
  ...
  keywords: "tarifs taxi cagnes-sur-mer, prix transfert aéroport nice, tarif taxi monaco, prix taxi antibes",
}

export default function Pricing() {
  const routes = [
    { from: "Aéroport Nice", to: "Cagnes-sur-Mer Centre", price: 45 },
    { from: "Aéroport Nice", to: "Haut-de-Cagnes", price: 50 },
    { from: "Cagnes-sur-Mer", to: "Monaco", price: 85 },
    { from: "Cagnes-sur-Mer", to: "Antibes", price: 35 },
    { from: "Cagnes-sur-Mer", to: "Cannes", price: 40 },
    { from: "Cagnes-sur-Mer", to: "Nice Centre", price: 30 },
  ]
